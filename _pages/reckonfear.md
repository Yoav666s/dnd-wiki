...
**Poisoned.** The creature is poisoned and at the end of each of its turns, it must succeed a Vigor check with Inverse Difficulty based on its Resilience (success with a cost counts as a failure) or lose a Stamina Point. On a critical failure, the creature loses 2 Stamina Points. If it has no remaining Stamina points, it takes 1d12 Poison damage on a failure, 2d12 Poison damage on a critical failure, and half damage on a success with a cost (rounded down).
