...
**Charisma.** Your capacity to affect other people through physical attractiveness, honeyed words, or commanding presence.
...
## Skills
There are 24 skills, each linked to a Character Attribute. You can choose 7 skills to gain competence in. You cannot gain competence in a skill if the respective Attribute Value is lower than 4.
...
**Recall.** Make a Recall check to learn one general piece of information about a creature or the environment. The Reckoner decides what the DT is depending on the situation and your Position, and if a roll is even necessary.
...
**Frostbite.** A layer of frost forms around a creature you can see within range. The target takes 1d8 Frost damage and the DT of every attack it makes is increased by 2 until the end of its next turn.

**Propel.** You propel a small object within range to hit a target. Make an attack against a creature or object you can see within range. On a hit, both the target and the propelled object take 3d4 Blunt damage.
...
**Fireball.** Make an attack against a creature you can see within range. On a hit, it takes Fire damage equal to 3d12 and starts Burning. On a miss, it takes half damage only.
...
**Poisoned.** The creature is poisoned and must succeed a Vigor check with Inverse Difficulty based on its Resilience (success with a cost counts as a failure) at the end of each of its turns or lose a Stamina Point. On a critical failure, the creature loses 2 Stamina Points. If it runs out of stamina before the effect ends, it takes 1d12 Poison damage on a failure, 2d12 Poison damage on a critical failure, and 1d6 Poison damage on a success with a cost.
