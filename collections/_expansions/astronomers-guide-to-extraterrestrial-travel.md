...
The atmosphere there consists of Neon (\~49%), Oxygen (\~21%), Krypton (\~26%), and Methane (\~2-3%), as well as vapors and dust, which is breathable for terrestrial creatures without requiring significant adaptation. Methane causes the blue tint, while Oxygen makes this planet habitable for terrestrial creatures.
