...
As it turns out, Toolscrap is the goblin. He's very down-to-business with no care for smalltalk. When the player explains that they want to hire guards for their mansion, Toolscrap will not look too happy about it. The player will have to pass a Charisma (Persuasion) check (DC equal 8 + twice the number of guards they want to hire), which they can make with advantage since Tallis is with them. On success, Toolscrap will let the PC hire as many mercenaries as they need if they pay him 3 GP per mercenary. He will not haggle on this price. On failure, if the player is wearing the *Headband of Intellect*, Toolscrap will recognize it.
