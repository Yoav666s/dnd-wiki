...
# Tactical Command
Starting at 3rd level, once on your turn when you take the [[Help]] action to aid an ally in attacking a creature, you can command the ally to attack that creature. The ally can use a reaction to make that attack if the target is within range.
