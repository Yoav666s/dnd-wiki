...
index:
  - arcane-soul
permalink: /classes/sorcerer/arcane-soul/
excerpt: "You are a master of the arcane arts, your magic stemming from a deep connection to the weave."
subclass: sorcerer
alt_version: arcane-sorcery
header:
  overlay_image: /assets/images/classes/sorcerer/arcane-soul/header.png
  teaser: /assets/images/classes/sorcerer/arcane-soul/header.jpg
---
You are a master of the arcane arts, your magic stemming from a deep connection to the weave.

# Arcane Magic
Starting at 1st level, you learn additional spells when you reach certain levels in this class, as shown on the Arcane Spells table. Each spell counts as a sorcerer spell for you, but it doesn’t count against the number of sorcerer spells you know. These spells can’t be replaced when you gain a level in this class.
...
# Metamorphosis
Starting at 18th level, you learn the [[Shapechange]] and [[True Polymorph]] spells, and you can cast them using an appropriate spell slot. When you cast these spells, they gain the following benefits.

**Shapechange.** You can concentrate on this spell for a duration of 8 hours.
