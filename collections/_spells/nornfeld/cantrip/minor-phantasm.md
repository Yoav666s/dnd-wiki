...
description: |
  ...
  The target is so convinced of the phantasm’s reality that it can even take damage from the illusion: it takes 1d4 psychic damage if it is in the phantasm’s area, provided that the illusion is of a hazard or a creature that could logically deal damage, such as a burning flame or a swarm of bees. The target perceives the damage as a type appropriate to the illusion, and then makes another Intelligence saving throw. 
